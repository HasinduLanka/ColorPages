...
<div class="flex">
  <div class="flex-1">
    <div class="p-4 mx-auto text-center max-w-xl " on:click={LogoClick}>
      <h1
        class="uppercase text-6xl leading-normal text-purple-700 animate-pulse shadow-md"
      >
        Color Pages
      </h1>
      <h2
        class="text-4xl leading-normal text-gray-500 rounded-xl m-auto shadow-md"
      >
        colors.pages.dev
      </h2>
    </div>
